...
- [x] 1.1 Property test: publish gate is exactly the blocker predicate
...
- [x] 2. Create the readiness value objects
  ...
  - [x] 2.4 Property test: capacity comparison classifies the ceiling correctly
...
- [x] 3. Create the EventReadiness service
  ...
  - [x] 3.1 Property test: checklist reflects event state
  ...
  - [x] 3.2 Property test: blocking items match the publish source of truth
  ...
  - [x] 3.3 Property test: capacity warnings never block publishing
  ...
  - [x] 3.4 Unit tests for EventReadiness checklist and capacity states
...
- [x] 6. Create the EventReportService (single accounting source of truth)
  ...
  - [x] 6.1 Property test: confirmed-order accounting definitions
  ...
  - [x] 6.2 Property test: capacity utilisation honours unlimited
  ...
  - [x] 6.3 Property test: per-ticket-type breakdown is consistent
  ...
  - [x] 6.4 Property test: orders-by-status breakdown is exhaustive
  ...
  - [x] 6.5 Property test: sales-over-time matches grouped sums
  ...
  - [x] 6.6 Unit tests for EventReportService accounting
...
- [x] 7. Refactor ReportController to delegate per-event accounting
  ...
  - [x] 7.1 Property test: per-event figures agree with the company report
...
- [x] 9. Update EventController for publish gating, QR, and show view data
  ...
  - [x] 9.2 Add `EventController::qr(Event $event, QrService $qr): Response`
  ...
  - [x] 9.3 Extend `EventController::show()` with readiness, capacity, public URL, and report view data
...
- [x] 10. Create the EventReportController
