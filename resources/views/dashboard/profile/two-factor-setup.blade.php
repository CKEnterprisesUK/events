...
<style>
    ...
    .mfa-steps { margin: 0; padding-left: 1.1rem; }
    .mfa-steps li { margin-bottom: 0.4rem; }
...
@section('content')
    <div class="page-head">
        ...
        <a href="{{ route('dashboard.profile.edit') }}#two-factor" class="btn btn-outline">Cancel</a>
    </div>
    ...
    <div class="mfa-setup">
        <div class="panel">
            ...
            <div class="panel__body">
                ...
                <div class="mfa-qr">
                    <img src="{{ route('dashboard.profile.two-factor.qr') }}"
        ...
        <div class="panel">
            ...
            <div class="panel__body">
                ...
                <form method="POST" action="{{ route('dashboard.profile.two-factor.confirm') }}" class="mfa-form">
                    @csrf
                    <div class="field">
                    ...
                    <div class="mfa-actions">
                        ...
                        <a href="{{ route('dashboard.profile.edit') }}#two-factor" class="muted">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
